...
('adoptant', 'Claire Lefevre', 'claire.lefevre@example.com', 'hashed_password10', 'France', 13001, 'Marseille', 5.3698, 43.2965, '0123456787', '10 Rue Saint-Ferréol', NULL, 'Passionnée par les chats et les rongeurs.'),
('adoptant', 'Luc Moreau', 'luc.moreau@example.com', 'hashed_password11', 'France', 34000, 'Montpellier', 3.8772, 43.6119, '0123456788', '12 Rue de la Loge', NULL, 'Aime les reptiles.'),
('adoptant', 'Lucas Martin', 'lucas.martin@example.com', 'hashed_password7', 'France', 69002, 'Lyon', 4.8357, 45.7578, '0123456796', '1 Place Bellecour', NULL, 'Amoureux des chats.'),
('adoptant', 'Clara Petit', 'clara.petit@example.com', 'hashed_password8', 'France', 06000, 'Nice', 7.2619, 43.7102, '0123456797', '1 Promenade des Anglais', NULL, 'Cherche un compagnon canin.'),
('adoptant', 'Victor Hugo', 'victor.hugo@example.com', 'hashed_password9', 'France', 13001, 'Marseille', 5.3698, 43.2965, '0123456798', '10 Rue de la République', NULL, 'Grand passionné de chevaux.'),
('adoptant', 'Julien Lambert', 'julien.lambert@example.com', 'hashed_password12', 'France', 57000, 'Metz', 6.1757, 49.1193, '0123456793', '5 Rue des Roches', NULL, 'Grand amateur de chiens.'),
('adoptant', 'Sophie Morel', 'sophie.morel@example.com', 'hashed_password13', 'France', 82000, 'Montauban', 1.3684, 44.0221, '0123456794', '2 Rue du Collège', NULL, 'Adoptante depuis plusieurs années.'),
('adoptant', 'Lucas Duhamel', 'lucas.duhamel@example.com', 'hashed_password14', 'France', 38000, 'Grenoble', 5.7245, 45.1885, '0123456795', '8 Rue Emile Laugier', NULL, 'Passionné par les petits animaux.'),
('adoptant', 'Emma Thomas', 'emma.thomas@example.com', 'hashed_password15', 'France', 31000, 'Toulouse', 1.4442, 43.6047, '0123456796', '12 Rue de Metz', NULL, 'Amoureuse des chats.'),
('adoptant', 'Arthur Lefebvre', 'arthur.lefebvre@example.com', 'hashed_password16', 'France', 21000, 'Dijon', 5.0415, 47.3220, '0123456797', '3 Boulevard de l''Ouest', NULL, 'Cherche à adopter un chien.'),
('adoptant', 'Manon Renault', 'manon.renault@example.com', 'hashed_password17', 'France', 92210, 'Saint-Cloud', 2.2097, 48.8441, '0123456798', '5 Parc de la Bérengère', NULL, 'Amatrice de NAC.'),
...
('famille d''accueil', 'Sylvie Bernard', 'sylvie.bernard@example.com', 'hashed_password5', 'France', 54000, 'Nancy', 6.1844, 48.6921, '0123456786', '15 Rue Saint-Dizier', NULL, 'Famille habituée aux petits animaux.'),
('famille d''accueil', 'Thomas Richard', 'thomas.richard@example.com', 'hashed_password6', 'France', 35000, 'Rennes', -1.6778, 48.1173, '0123456799', '18 Rue de la Monnaie', NULL, 'Spécialisé dans l’accueil des oiseaux.'),
('famille d''accueil', 'Sophie Durand', 'sophie.durand@example.com', 'hashed_password22', 'France', 44000, 'Nantes', -1.5536, 47.2184, '0123456799', '5 Rue Crébillon', NULL, 'Famille habituée à accueillir des NAC.'),
('famille d''accueil', 'Pierre Rolland', 'pierre.rolland@example.com', 'hashed_password23', 'France', 69003, 'Lyon', 4.8414, 45.7578, '0123456703', '4 Rue de la Part-Dieu', NULL, 'Expérimenté dans l''accueil de chiens.'),
...
('famille d''accueil', 'Louis Martin', 'louis.martin@example.com', 'hashed_password31', 'France', 69006, 'Lyon', 4.8494, 45.7675, '0123456711', '10 Boulevard des Belges', NULL, 'Famille d''accueil de NAC.'),
('famille d''accueil', 'Isabelle Petit', 'isabelle.petit@example.com', 'hashed_password32', 'France', 31000, 'Toulouse', 1.4442, 43.6047, '0123456712', '6 Rue de la Pomme', NULL, 'Famille d''accueil expérimentée.'),
